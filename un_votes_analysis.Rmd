...
write.csv(no_by_year, file='no_by_year.csv')
write.csv(no_by_year_country, file='no_by_year_country.csv')
```

Testing
```{r}
cor(no_by_year_country[, c('China', 'France', 'Russia', 'United Kingdom', 'United States')])
